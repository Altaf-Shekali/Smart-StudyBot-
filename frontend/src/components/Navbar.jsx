...
const MyComponent = () => {
      ...
      <nav>
        {navigation.map((item) => (
          <div
            ...
            className="cursor-pointer flex items-center space-x-2 p-2 hover:bg-gray-100"
          >
  ...
  const navigation = [
    { name: 'Home', href: '/', icon: AcademicCapIcon, current: true },
    { name: 'Subjects', href: '/subjects', icon: BookOpenIcon, current: false },
    { name: 'History', href: '/history', icon: BookOpenIcon, current: false },
